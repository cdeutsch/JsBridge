...
WriteLiteral(" href=\"javascript:Mt.App.fireEvent(\'nativeSheet\', { msg: \'My custom action\' });\"");

WriteLiteral(">Click Me to show a Native Action Sheet</a>\n            <br>\n\t\t</div>\n\n        <!" +
"-- Be sure you include a copy of mt.js or call \"myWebView.InjectMtJavascript();\"" +
" on every page you want to use JsBridg in -->\n        <script");

WriteLiteral(" src=\"js/mt.js\"");
